    ...
    switch ($status) {
        ...
        case 'linksent_simulation':
            if (isset($_GET['reset_link'])) {
                $message_text = "หากข้อมูลถูกต้อง ลิงก์สำหรับรีเซ็ตรหัสผ่านถูกสร้างขึ้นแล้ว: <br><a href='" . htmlspecialchars(urldecode($_GET['reset_link'])) . "'>" . "Go to reset Password" . "</a><br><strong>คำแนะนำ:</strong> คัดลอกลิงก์นี้แล้วเปิดในเบราว์เซอร์ใหม่ หรือคลิกที่นี่";
